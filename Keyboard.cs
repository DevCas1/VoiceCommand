...
namespace VoiceCommand
{
    ...
    {
        public static void SendInput(Scancode scancode) => SendInput(1, new Input[] { GetKBInputFromScancode(scancode) }, Marshal.SizeOf(typeof(Input)));
        ...
        public static void SendInputs(Scancode[] scancodes)
        {
            ...
            {
                inputs[index] = GetKBInputFromScancode(scancodes[index]);
            }

            SendInput((uint)inputs.Length, inputs, Marshal.SizeOf(typeof(Input)));
        }

        public static ushort GetScancode(Scancode code) => (ushort)code;
        ...
        private static Input GetKBInputFromScancode(Scancode scancode) => new Input
        {
